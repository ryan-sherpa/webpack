...
class Pack {
	...
	get(identifier, etag) {
		...
		console.log("Pack.get", `identifier: ${identifier}`, `etag: ${etag}`)
		if (info === undefined) {
			return undefined;
		}
	...
	set(identifier, etag, data) {
		console.log("Pack.set", `identifier: ${identifier}`, `etag: ${etag}`)
		if (!this.invalid) {
			this.invalid = true;
...
class PackContent {
	...
	*/
	...
	get(identifier) {
		console.log("PackContent.get", `identifier: ${identifier}`)
